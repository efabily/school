...
abstract class BasesfGuardUserPeer {
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(NightAuditPeer::USER_ID, $obj->getId());
			...
			$criteria->add(CashBoxPeer::CASHIER_ID, $obj->getId());
			...
			$criteria->add(CurrencyPricePeer::USER_ID, $obj->getId());
			...
			$criteria->add(SalesPeer::CASHIER_ID, $obj->getId());
			...
			$criteria->add(DepositPeer::CASHIER_ID, $obj->getId());
			...
			$criteria->add(TransferPeer::USER_ID, $obj->getId());
