...
abstract class BasesfGuardUser extends BaseObject  implements Persistent {
	 ...
	 * related NightAudits from storage. If this sfGuardUser is new, it will return
		...
		if ($this->collNightAudits === null) {
			if ($this->isNew()) {
			   $this->collNightAudits = array();
				...
				$criteria->add(NightAuditPeer::USER_ID, $this->id);
	 ...
	 */
	public function getNightAuditsJoinBusinessEntity($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collNightAudits === null) {
			if ($this->isNew()) {
				...
				$this->collNightAudits = NightAuditPeer::doSelectJoinBusinessEntity($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related CashBoxs from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collCashBoxs === null) {
			if ($this->isNew()) {
			   $this->collCashBoxs = array();
				...
				$criteria->add(CashBoxPeer::CASHIER_ID, $this->id);
	 ...
	 * actually need in sfGuardUser.
	 */
	public function getCashBoxsJoinNightAudit($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collCashBoxs === null) {
			if ($this->isNew()) {
				...
				$this->collCashBoxs = CashBoxPeer::doSelectJoinNightAudit($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related CurrencyPrices from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collCurrencyPrices === null) {
			if ($this->isNew()) {
			   $this->collCurrencyPrices = array();
				...
				$criteria->add(CurrencyPricePeer::USER_ID, $this->id);
	 ...
	 * actually need in sfGuardUser.
	 */
	public function getCurrencyPricesJoinCurrency($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collCurrencyPrices === null) {
			if ($this->isNew()) {
				...
				$this->collCurrencyPrices = CurrencyPricePeer::doSelectJoinCurrency($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related Saless from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collSaless === null) {
			if ($this->isNew()) {
			   $this->collSaless = array();
				...
				$criteria->add(SalesPeer::CASHIER_ID, $this->id);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related Deposits from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collDeposits === null) {
			if ($this->isNew()) {
			   $this->collDeposits = array();
				...
				$criteria->add(DepositPeer::CASHIER_ID, $this->id);
	 ...
	 * actually need in sfGuardUser.
	 */
	public function getDepositsJoinCurrency($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collDeposits === null) {
			if ($this->isNew()) {
				...
				$this->collDeposits = DepositPeer::doSelectJoinCurrency($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
