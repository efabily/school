...
class sfGuardUserTableMap extends TableMap {
	...
	{
    $this->addRelation('NightAudit', 'NightAudit', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'CASCADE', 'RESTRICT');
    $this->addRelation('CashBox', 'CashBox', RelationMap::ONE_TO_MANY, array('id' => 'cashier_id', ), 'CASCADE', 'RESTRICT');
    $this->addRelation('CurrencyPrice', 'CurrencyPrice', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'CASCADE', 'RESTRICT');
    $this->addRelation('Sales', 'Sales', RelationMap::ONE_TO_MANY, array('id' => 'cashier_id', ), 'CASCADE', 'RESTRICT');
    $this->addRelation('Deposit', 'Deposit', RelationMap::ONE_TO_MANY, array('id' => 'cashier_id', ), 'CASCADE', 'RESTRICT');
    $this->addRelation('Transfer', 'Transfer', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'CASCADE', 'RESTRICT');
