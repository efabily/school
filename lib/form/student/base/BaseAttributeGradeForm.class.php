...
/**
 * AttributeGrade form base class.
 *
 * @method AttributeGrade getObject() Returns the current form's model object
 *
 * @package    school
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseAttributeGradeForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('attribute_grade[%s]');
