...
/**
 * SalesDeposit form base class.
 *
 * @method SalesDeposit getObject() Returns the current form's model object
 *
 * @package    school
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseSalesDepositForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('sales_deposit[%s]');
