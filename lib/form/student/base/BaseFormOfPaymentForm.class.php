...
/**
 * FormOfPayment form base class.
 *
 * @method FormOfPayment getObject() Returns the current form's model object
 *
 * @package    school
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseFormOfPaymentForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('form_of_payment[%s]');
