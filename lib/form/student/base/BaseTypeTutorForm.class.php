...
/**
 * TypeTutor form base class.
 *
 * @method TypeTutor getObject() Returns the current form's model object
 *
 * @package    school
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseTypeTutorForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('type_tutor[%s]');
