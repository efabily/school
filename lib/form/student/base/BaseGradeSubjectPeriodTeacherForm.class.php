...
/**
 * GradeSubjectPeriodTeacher form base class.
 *
 * @method GradeSubjectPeriodTeacher getObject() Returns the current form's model object
 *
 * @package    school
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseGradeSubjectPeriodTeacherForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('grade_subject_period_teacher[%s]');
