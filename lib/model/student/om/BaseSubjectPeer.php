...
/**
 * Base static class for performing query and update operations on the 'sch_subject' table.
 *
 * 
 *
...
abstract class BaseSubjectPeer {
	...
	const TABLE_NAME = 'sch_subject';

	/** the related Propel class for this table */
	const OM_CLASS = 'Subject';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.student.Subject';
	...
	const ID = 'sch_subject.ID';

	/** the column name for the ID_STATE field */
	const ID_STATE = 'sch_subject.ID_STATE';

	/** the column name for the NAME field */
	const NAME = 'sch_subject.NAME';

	/** the column name for the DESCRIPTION field */
	const DESCRIPTION = 'sch_subject.DESCRIPTION';

	/** the column name for the DELETED_BY field */
	const DELETED_BY = 'sch_subject.DELETED_BY';

	/** the column name for the CREATED_AT field */
	const CREATED_AT = 'sch_subject.CREATED_AT';

	/** the column name for the UPDATED_AT field */
	const UPDATED_AT = 'sch_subject.UPDATED_AT';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(SubjectPeer::ID_STATE);
		$criteria->addSelectColumn(SubjectPeer::NAME);
		$criteria->addSelectColumn(SubjectPeer::DESCRIPTION);
		$criteria->addSelectColumn(SubjectPeer::DELETED_BY);
	...
	/**
	 * Method to invalidate the instance pool of all tables related to sch_subject
	...
	/**
	 * Method to DELETE all rows from the sch_subject table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += SubjectPeer::doOnDeleteCascade(new Criteria(SubjectPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += SubjectPeer::doOnDeleteCascade($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(GradeSubjectPeer::SUBJECT_ID, $obj->getId());
