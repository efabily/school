...
/**
 * Base static class for performing query and update operations on the 'sch_currency' table.
 *
 * 
 *
...
abstract class BaseCurrencyPeer {
	...
	const TABLE_NAME = 'sch_currency';

	/** the related Propel class for this table */
	const OM_CLASS = 'Currency';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.student.Currency';
	...
	const ID = 'sch_currency.ID';

	/** the column name for the ID_STATE field */
	const ID_STATE = 'sch_currency.ID_STATE';

	/** the column name for the DELETED_BY field */
	const DELETED_BY = 'sch_currency.DELETED_BY';

	/** the column name for the CREATED_AT field */
	const CREATED_AT = 'sch_currency.CREATED_AT';

	/** the column name for the UPDATED_AT field */
	const UPDATED_AT = 'sch_currency.UPDATED_AT';

	/** the column name for the NAME field */
	const NAME = 'sch_currency.NAME';

	/** the column name for the DESCRIPTION field */
	const DESCRIPTION = 'sch_currency.DESCRIPTION';

	/** the column name for the EXCHANGE_RATE field */
	const EXCHANGE_RATE = 'sch_currency.EXCHANGE_RATE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'IdState', 'DeletedBy', 'CreatedAt', 'UpdatedAt', 'Name', 'Description', 'ExchangeRate', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'idState', 'deletedBy', 'createdAt', 'updatedAt', 'name', 'description', 'exchangeRate', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ID_STATE, self::DELETED_BY, self::CREATED_AT, self::UPDATED_AT, self::NAME, self::DESCRIPTION, self::EXCHANGE_RATE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'id_state', 'deleted_by', 'created_at', 'updated_at', 'name', 'description', 'exchange_rate', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'IdState' => 1, 'DeletedBy' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, 'Name' => 5, 'Description' => 6, 'ExchangeRate' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'idState' => 1, 'deletedBy' => 2, 'createdAt' => 3, 'updatedAt' => 4, 'name' => 5, 'description' => 6, 'exchangeRate' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ID_STATE => 1, self::DELETED_BY => 2, self::CREATED_AT => 3, self::UPDATED_AT => 4, self::NAME => 5, self::DESCRIPTION => 6, self::EXCHANGE_RATE => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'id_state' => 1, 'deleted_by' => 2, 'created_at' => 3, 'updated_at' => 4, 'name' => 5, 'description' => 6, 'exchange_rate' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CurrencyPeer::ID_STATE);
		$criteria->addSelectColumn(CurrencyPeer::DELETED_BY);
		...
		$criteria->addSelectColumn(CurrencyPeer::DESCRIPTION);
		$criteria->addSelectColumn(CurrencyPeer::EXCHANGE_RATE);
	}
	...
	/**
	 * Method to invalidate the instance pool of all tables related to sch_currency
	 * by a foreign key with ON DELETE CASCADE
	 */
	public static function clearRelatedInstancePool()
	{
		// invalidate objects in CurrencyPricePeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
		...
		// invalidate objects in DepositPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	/**
	 * Method to DELETE all rows from the sch_currency table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += CurrencyPeer::doOnDeleteCascade(new Criteria(CurrencyPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += CurrencyPeer::doOnDeleteCascade($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related CurrencyPrice objects
			$criteria = new Criteria(CurrencyPricePeer::DATABASE_NAME);
			
			$criteria->add(CurrencyPricePeer::CURRENCY_ID, $obj->getId());
			$affectedRows += CurrencyPricePeer::doDelete($criteria, $con);

			// delete related PaymentType objects
			$criteria = new Criteria(PaymentTypePeer::DATABASE_NAME);
			
			$criteria->add(PaymentTypePeer::CURRENCY_ID, $obj->getId());
			$affectedRows += PaymentTypePeer::doDelete($criteria, $con);

			// delete related Deposit objects
			$criteria = new Criteria(DepositPeer::DATABASE_NAME);
			
			$criteria->add(DepositPeer::CURRENCY_ID, $obj->getId());
			$affectedRows += DepositPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
