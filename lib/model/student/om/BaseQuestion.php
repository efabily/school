...
/**
 * Base class that represents a row from the 'sch_question' table.
 *
 * 
 *
...
abstract class BaseQuestion extends BaseObject  implements Persistent {
	...
	public function setIdState($v)
	{
		...
		if ($this->id_state !== $v) {
			$this->id_state = $v;
			$this->modifiedColumns[] = QuestionPeer::ID_STATE;
		}
	...
	public function setReply($v)
	{
		...
		if ($this->reply !== $v) {
			$this->reply = $v;
			$this->modifiedColumns[] = QuestionPeer::REPLY;
		}
	...
	public function setContractId($v)
	{
		...
		if ($this->contract_id !== $v) {
			$this->contract_id = $v;
			$this->modifiedColumns[] = QuestionPeer::CONTRACT_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->reply = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setReply($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(QuestionPeer::ID_STATE)) $criteria->add(QuestionPeer::ID_STATE, $this->id_state);
		if ($this->isColumnModified(QuestionPeer::QUESTION)) $criteria->add(QuestionPeer::QUESTION, $this->question);
		if ($this->isColumnModified(QuestionPeer::REPLY)) $criteria->add(QuestionPeer::REPLY, $this->reply);
		...
		if ($this->isColumnModified(QuestionPeer::CONTRACT_ID)) $criteria->add(QuestionPeer::CONTRACT_ID, $this->contract_id);
	...
	public function getContract(PropelPDO $con = null)
	{
		if ($this->aContract === null && ($this->contract_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aContract->addQuestions($this);
			 */
		}
