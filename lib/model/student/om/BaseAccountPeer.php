...
/**
 * Base static class for performing query and update operations on the 'sch_account' table.
 *
 * 
 *
...
abstract class BaseAccountPeer {
	...
	const TABLE_NAME = 'sch_account';

	/** the related Propel class for this table */
	const OM_CLASS = 'Account';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.student.Account';
	...
	const ID = 'sch_account.ID';

	/** the column name for the ID_STATE field */
	const ID_STATE = 'sch_account.ID_STATE';

	/** the column name for the NAME field */
	const NAME = 'sch_account.NAME';

	/** the column name for the NUMBER field */
	const NUMBER = 'sch_account.NUMBER';

	/** the column name for the DELETED_BY field */
	const DELETED_BY = 'sch_account.DELETED_BY';

	/** the column name for the CREATED_AT field */
	const CREATED_AT = 'sch_account.CREATED_AT';

	/** the column name for the UPDATED_AT field */
	const UPDATED_AT = 'sch_account.UPDATED_AT';

	/** the column name for the CONTRACT_ID field */
	const CONTRACT_ID = 'sch_account.CONTRACT_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'IdState', 'Name', 'Number', 'DeletedBy', 'CreatedAt', 'UpdatedAt', 'ContractId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'idState', 'name', 'number', 'deletedBy', 'createdAt', 'updatedAt', 'contractId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ID_STATE, self::NAME, self::NUMBER, self::DELETED_BY, self::CREATED_AT, self::UPDATED_AT, self::CONTRACT_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'id_state', 'name', 'number', 'deleted_by', 'created_at', 'updated_at', 'contract_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'IdState' => 1, 'Name' => 2, 'Number' => 3, 'DeletedBy' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, 'ContractId' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'idState' => 1, 'name' => 2, 'number' => 3, 'deletedBy' => 4, 'createdAt' => 5, 'updatedAt' => 6, 'contractId' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ID_STATE => 1, self::NAME => 2, self::NUMBER => 3, self::DELETED_BY => 4, self::CREATED_AT => 5, self::UPDATED_AT => 6, self::CONTRACT_ID => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'id_state' => 1, 'name' => 2, 'number' => 3, 'deleted_by' => 4, 'created_at' => 5, 'updated_at' => 6, 'contract_id' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(AccountPeer::ID_STATE);
		$criteria->addSelectColumn(AccountPeer::NAME);
		$criteria->addSelectColumn(AccountPeer::NUMBER);
		$criteria->addSelectColumn(AccountPeer::DELETED_BY);
	...
	/**
	 * Method to invalidate the instance pool of all tables related to sch_account
	...
	public static function doCountJoinContract(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(AccountPeer::CONTRACT_ID, ContractPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Account objects pre-filled with their Contract objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinContract(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Account) to $obj2 (Contract)
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Account) to the collection in $obj2 (Contract)
				$obj2->addAccount($obj1);
	...
	/**
	 * Method to DELETE all rows from the sch_account table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(ClassroomPeer::ACCOUNT_ID, $obj->getId());
			...
			$criteria->add(SaleAccountPeer::ACCOUNT_ID, $obj->getId());
			...
			$criteria->add(AccountDepositPeer::ACCOUNT_ID, $obj->getId());
