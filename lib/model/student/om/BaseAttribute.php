...
/**
 * Base class that represents a row from the 'sch_attribute' table.
 *
 * 
 *
...
abstract class BaseAttribute extends BaseObject  implements Persistent {
	...
	public function setIdState($v)
	{
		...
		if ($this->id_state !== $v) {
			$this->id_state = $v;
			$this->modifiedColumns[] = AttributePeer::ID_STATE;
		}
	...
	public function setKey($v)
	{
		...
		if ($this->key !== $v) {
			$this->key = $v;
			$this->modifiedColumns[] = AttributePeer::KEY;
		}
	...
	public function setValue($v)
	{
		...
		if ($this->value !== $v) {
			$this->value = $v;
			$this->modifiedColumns[] = AttributePeer::VALUE;
		}
	...
	public function setDeletedBy($v)
	{
		...
		if ($this->deleted_by !== $v) {
			$this->deleted_by = $v;
			$this->modifiedColumns[] = AttributePeer::DELETED_BY;
		}
	...
	public function setPersonId($v)
	{
		...
		if ($this->person_id !== $v) {
			$this->person_id = $v;
			$this->modifiedColumns[] = AttributePeer::PERSON_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 10; // 10 = AttributePeer::NUM_COLUMNS - AttributePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseAttribute:delete:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseAttribute:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseAttribute:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseAttribute:save:post') as $callable)
				{
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AttributePeer::ID_STATE)) $criteria->add(AttributePeer::ID_STATE, $this->id_state);
		if ($this->isColumnModified(AttributePeer::KEY)) $criteria->add(AttributePeer::KEY, $this->key);
		if ($this->isColumnModified(AttributePeer::VALUE)) $criteria->add(AttributePeer::VALUE, $this->value);
		...
		if ($this->isColumnModified(AttributePeer::DELETED_BY)) $criteria->add(AttributePeer::DELETED_BY, $this->deleted_by);
		...
		if ($this->isColumnModified(AttributePeer::PERSON_ID)) $criteria->add(AttributePeer::PERSON_ID, $this->person_id);
	...
	public function getPerson(PropelPDO $con = null)
	{
		if ($this->aPerson === null && ($this->person_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aPerson->addAttributes($this);
			 */
		}
		return $this->aPerson;
	}
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseAttribute:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseAttribute::%s', $method));
	  }
