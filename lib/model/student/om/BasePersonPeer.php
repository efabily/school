...
/**
 * Base static class for performing query and update operations on the 'sch_person' table.
 *
 * 
 *
...
abstract class BasePersonPeer {
	...
	const TABLE_NAME = 'sch_person';

	/** the related Propel class for this table */
	const OM_CLASS = 'Person';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.student.Person';
	...
	const ID = 'sch_person.ID';

	/** the column name for the ID_STATE field */
	const ID_STATE = 'sch_person.ID_STATE';

	/** the column name for the DELETED_BY field */
	const DELETED_BY = 'sch_person.DELETED_BY';

	/** the column name for the CREATED_AT field */
	const CREATED_AT = 'sch_person.CREATED_AT';

	/** the column name for the UPDATED_AT field */
	const UPDATED_AT = 'sch_person.UPDATED_AT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'IdState', 'DeletedBy', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'idState', 'deletedBy', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ID_STATE, self::DELETED_BY, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'id_state', 'deleted_by', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'IdState' => 1, 'DeletedBy' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'idState' => 1, 'deletedBy' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ID_STATE => 1, self::DELETED_BY => 2, self::CREATED_AT => 3, self::UPDATED_AT => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'id_state' => 1, 'deleted_by' => 2, 'created_at' => 3, 'updated_at' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PersonPeer::ID_STATE);
		$criteria->addSelectColumn(PersonPeer::DELETED_BY);
	...
	/**
	 * Method to invalidate the instance pool of all tables related to sch_person
	 * by a foreign key with ON DELETE CASCADE
	 */
	public static function clearRelatedInstancePool()
	{
		// invalidate objects in AttributePeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	/**
	 * Method to DELETE all rows from the sch_person table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(AttributePeer::PERSON_ID, $obj->getId());
			...
			$criteria->add(StudentPeer::PERSON_ID, $obj->getId());
			$affectedRows += StudentPeer::doDelete($criteria, $con);

			// delete related Tutor objects
			$criteria = new Criteria(TutorPeer::DATABASE_NAME);
			
			$criteria->add(TutorPeer::PERSON_ID, $obj->getId());
