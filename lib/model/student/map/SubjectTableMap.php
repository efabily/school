...
/**
 * This class defines the structure of the 'sch_subject' table.
 *
 *
...
class SubjectTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.student.map.SubjectTableMap';
	...
	{
    $this->addRelation('GradeSubject', 'GradeSubject', RelationMap::ONE_TO_MANY, array('id' => 'subject_id', ), 'CASCADE', 'RESTRICT');
	} // buildRelations()
