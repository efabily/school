...
/**
 * This class defines the structure of the 'sch_transfer' table.
 *
 *
...
class TransferTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.student.map.TransferTableMap';
    ...
    $this->addRelation('MovementCashboxTransfer', 'MovementCashboxTransfer', RelationMap::ONE_TO_MANY, array('id' => 'transfer_id', ), 'CASCADE', 'RESTRICT');
    $this->addRelation('TransferBillet', 'TransferBillet', RelationMap::ONE_TO_MANY, array('id' => 'transfer_id', ), 'CASCADE', 'RESTRICT');
	} // buildRelations()
