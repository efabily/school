...
/**
 * This class defines the structure of the 'sch_attribute_contract' table.
 *
 *
 ...
 */
class AttributeContractTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.student.map.AttributeContractTableMap';
	...
	{
	  // attributes
		$this->setName('sch_attribute_contract');
		$this->setPhpName('AttributeContract');
		$this->setClassname('AttributeContract');
		$this->setPackage('lib.model.student');
		$this->setUseIdGenerator(true);
		// columns
		$this->addPrimaryKey('ID', 'Id', 'INTEGER', true, null, null);
		$this->addColumn('ID_STATE', 'IdState', 'INTEGER', true, null, null);
		$this->addColumn('KEY', 'Key', 'VARCHAR', true, 250, null);
