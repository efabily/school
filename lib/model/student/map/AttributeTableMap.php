...
/**
 * This class defines the structure of the 'sch_attribute' table.
 *
 *
...
class AttributeTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.student.map.AttributeTableMap';
	...
	{
	  // attributes
		$this->setName('sch_attribute');
		$this->setPhpName('Attribute');
		$this->setClassname('Attribute');
