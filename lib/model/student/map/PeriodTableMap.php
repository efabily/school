...
/**
 * This class defines the structure of the 'sch_period' table.
 *
 *
...
class PeriodTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.student.map.PeriodTableMap';
	...
	{
	  // attributes
		$this->setName('sch_period');
		$this->setPhpName('Period');
		$this->setClassname('Period');
	...
	{
    $this->addRelation('Contract', 'Contract', RelationMap::ONE_TO_MANY, array('id' => 'period_id', ), 'CASCADE', 'RESTRICT');
    $this->addRelation('GradeSubjectPeriod', 'GradeSubjectPeriod', RelationMap::ONE_TO_MANY, array('id' => 'period_id', ), 'CASCADE', 'RESTRICT');
	} // buildRelations()
