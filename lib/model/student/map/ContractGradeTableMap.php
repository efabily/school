 ...
 */
class ContractGradeTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.student.map.ContractGradeTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		$this->setPhpName('ContractGrade');
		$this->setClassname('ContractGrade');
