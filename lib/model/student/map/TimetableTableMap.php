...
/**
 * This class defines the structure of the 'sch_timetable' table.
 *
 *
...
class TimetableTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.student.map.TimetableTableMap';
	...
	{
    $this->addRelation('Grade', 'Grade', RelationMap::ONE_TO_MANY, array('id' => 'timetable_id', ), 'CASCADE', 'RESTRICT');
	} // buildRelations()
