...
/**
 * This class defines the structure of the 'sch_teacher' table.
 *
 *
...
class TeacherTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.student.map.TeacherTableMap';
	...
	{
    $this->addRelation('GradeSubjectPeriodTeacher', 'GradeSubjectPeriodTeacher', RelationMap::ONE_TO_MANY, array('id' => 'teacher_id', ), 'CASCADE', 'RESTRICT');
	} // buildRelations()
