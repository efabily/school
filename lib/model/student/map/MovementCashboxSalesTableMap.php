...
/**
 * This class defines the structure of the 'sch_movement_cashbox_sales' table.
 *
 *
 ...
 */
class MovementCashboxSalesTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.student.map.MovementCashboxSalesTableMap';
	...
	{
	  // attributes
		$this->setName('sch_movement_cashbox_sales');
		$this->setPhpName('MovementCashboxSales');
		$this->setClassname('MovementCashboxSales');
