...
/**
 * FormOfPayment filter form base class.
 *
 * @package    school
 * @subpackage filter
 * @author     Your name here
 */
abstract class BaseFormOfPaymentFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('form_of_payment_filters[%s]');
