...
<div id="sf_admin_container">
  ...
  <h2 style="font-size:20px;margin-bottom:10px">
     <a style="background-color:#ccc;padding:5px;color:#000" href="/Student/recordShort"  class="class_suffix">REGISTRO CORTO</a> | 
     <a href="/Student/new" class="class_suffix">REGISTRO COMPLETO</a></h2>
...
<div class="sf_admin_form">
  <?php echo form_tag_for($form, 'Student/saveRecordSort', array('method' => 'POST')) ?>
