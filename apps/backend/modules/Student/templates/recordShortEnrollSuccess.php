...
<div id="sf_admin_container">
  ...
  <h2 style="font-size:20px;margin-bottom:10px">
    <a style="background-color:#ccc;padding:5px;color:#000" href="/Student/recordShortEnroll/id/<?php echo $id; ?>"  class="class_suffix">
		INSCRIPCION CORTA
	</a>
		|
    <a  href="/Student/enroll/id/<?php echo $id; ?>" class="class_suffix">
...
<div class="sf_admin_form">
  <?php echo form_tag_for($form, 'Student/saveRecordSortEnroll', array('method' => 'POST')) ?>
