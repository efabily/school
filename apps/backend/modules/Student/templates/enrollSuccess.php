...
<div id="sf_admin_container">
  <h1 style="color:#000" ><?php echo __('INSCRIBIR ESTUDIANTE', array(), 'messages') ?></h1>

  <h2 style="font-size:20px;margin-bottom:10px">
     <a href="/Student/recordShortEnroll/id/<?php echo $id; ?>"  class="class_suffix">
	INSCRIPCION CORTA</a> |
     <a style="background-color:#ccc;padding:5px;color:#000" href="/Student/enroll/id/<?php echo $id; ?>" class="class_suffix">
...
<div class="sf_admin_form">
  <?php echo form_tag_for($form, 'Student/saveEnroll', array('method' => 'POST')) ?>
