...
class StudentEditForm extends BaseStudentForm
{
  ...
  public function configure()
  {
    parent::setup();
     ...
     $this->setWidgets(array( 
      ...
      'estudiante_nacimiento_pais' => new sfWidgetFormInputText(array(), array()),
      'fecha_nacimiento_dia' => new sfWidgetFormInputText(array(), array()),
      'fecha_nacimiento_mes' => new sfWidgetFormInputText(array(), array()),
      'fecha_nacimiento_anio' => new sfWidgetFormInputText(array(), array()),
      'estudiante_nacimiento_departamento' => new sfWidgetFormInputText(array(), array()),
      'estudiante_email' => new sfWidgetFormInputText(array(), array()),
      'estudiante_nacimiento_provincia' => new sfWidgetFormInputText(array(), array()),
      'estudiante_nacimiento_localidad' => new sfWidgetFormInputText(array(), array()),
      'certificado_nacimiento_oficialia' => new sfWidgetFormInputText(array(), array()),
      'certificado_nacimiento_libro' => new sfWidgetFormInputText(array(), array()),
      'certificado_nacimiento_partida' => new sfWidgetFormInputText(array(), array()),
      'certificado_nacimiento_folio' => new sfWidgetFormInputText(array(), array()),
      'estudiante_direccion_provincia' => new sfWidgetFormChoice(array('choices'  => DataSource::$PROVINCIAS), array()),
      'estudiante_direccion_zona_villa' => new sfWidgetFormInputText(array(), array('required' => false)),
      'estudiante_direccion_session_municipio' => new sfWidgetFormChoice(array('choices'  => ARRAY()), array()),
      'estudiante_direccion_avenida_calle' => new sfWidgetFormInputText(array(), array()),
      'estudiante_direccion_localidad_comunidad' => new sfWidgetFormInputText(array(), array()),
      'estudiante_direccion_celular' => new sfWidgetFormInputText(array(), array()),
      'estudiante_direccion_numero_vivienda' => new sfWidgetFormInputText(array(), array()),
      'idioma_nines' => new sfWidgetFormInputText(array(), array()),
      'idioma_habla_frecuentemente_1' => new sfWidgetFormChoice(array('choices'  => DataSource::$IDIOMAS), array()),
      'idioma_habla_frecuentemente_2' => new sfWidgetFormChoice(array('choices'  => DataSource::$IDIOMAS), array()),
      'idioma_habla_frecuentemente_3' => NEW sfWidgetFormChoice(array('choices'  => DataSource::$IDIOMAS), array()),
      ...
      'padre_tutor_grado_instruccion' => new sfWidgetFormChoice(array('choices'  => DataSource::$GRADO_INSTRUCCION, 'default' => ''), array()),
      'madre_grado_instruccion' => new sfWidgetFormChoice(array('choices'  => DataSource::$GRADO_INSTRUCCION, 'default' => ''), array()),
      'padre_tutor_parentesco' => new sfWidgetFormChoice(array('choices'  => DataSource::$PARENTESTO, 'default' => ''), array()),
      'madre_email' => new sfWidgetFormInputText(array(), array()),
      'padre_email' => new sfWidgetFormInputText(array(), array()),
      'fecha_registro_dia' => new sfWidgetFormInputText(array(), array()),
      'fecha_registro_mes' => new sfWidgetFormInputText(array(), array()),
      'fecha_registro_anio' => new sfWidgetFormInputText(array(), array()),
      'lugar_registro' => new sfWidgetFormInputText(array(), array())
    ));
     
    $this->setValidators(array(
      'id' => new sfValidatorChoice(array('choices' => array($this->getObject()->getId()), 'empty_value' => $this->getObject()->getId(), 'required' => false)),
      'contract_id' => new sfValidatorInteger(),
      'estudiante_nombre'  => new sfValidatorString(array('max_length' => 100, 'required' => true), array('required' => 'Obligatorio')),
      'estudiante_apellido_paterno' => new sfValidatorString(array('max_length' => 100, 'required' => true), array()),
      'estudiante_apellido_materno' => new sfValidatorString(array('max_length' => 100, 'required' => true), array()),
      ...
      'fecha_nacimiento_dia' => new sfValidatorString(array('max_length' => 100, 'required' => false), array()),
      'fecha_nacimiento_mes' => new sfValidatorString(array('max_length' => 100, 'required' => false), array()),
      'fecha_nacimiento_anio' => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      ...
      'fecha_registro_dia' => new sfValidatorString(array('max_length' => 100, 'required' => true)),
      'fecha_registro_mes' => new sfValidatorString(array('max_length' => 100, 'required' => true)),
      'fecha_registro_anio' => new sfValidatorString(array('max_length' => 100, 'required' => true)),
      'lugar_registro' => new sfValidatorString(array('max_length' => 100, 'required' => true)),
    ));
     
    
     // Tipo de documento
    $choices_tipo_documento = array('estudiante_ci' => 'C.I.', 'estudiante_pasaporte' => 'Pasaporte');
    $this->widgetSchema['tipo_documento'] = new sfWidgetFormChoice(array('expanded' => true,'choices'  => $choices_tipo_documento), array());
    ...
    {
       $this->widgetSchema['nivel_m'] = new sfWidgetFormChoice(array('expanded' => true,'choices'  => $array_nivel_1), array());
    ...
    $this->widgetSchema['pertenece'] = new sfWidgetFormChoice(array('expanded' => true, 'multiple' => true,'choices'  => $array_pertenece), array());
    ...
    $this->widgetSchema['hospital'] = new sfWidgetFormChoice(array('expanded' => true,'choices'  => $array_hospital), array());
    ...
    $this->widgetSchema['hospital_veces'] = new sfWidgetFormChoice(array('expanded' => true,'choices'  => $array_veces), array());
    ...
    $this->widgetSchema['discapacidad_sensorial'] = new sfWidgetFormChoice(array('expanded' => true,'choices'  => $array_discapacidad_sensorial), array());
    ...
    $this->widgetSchema['discapacidad_motriz'] = new sfWidgetFormChoice(array('expanded' => true,'choices'  => $array_discapacidad_motriz), array());
    ...
    $this->widgetSchema['discapacidad_mental'] = new sfWidgetFormChoice(array('expanded' => true,'choices'  => $array_discapacidad_mental), array());
    ...
    $this->widgetSchema['origen_discapacidad'] = new sfWidgetFormChoice(array('expanded' => true,'choices'  => $array_origen_discapacidad), array());
    ...
    $this->widgetSchema['acceso_servicio_basico'] = new sfWidgetFormChoice(array('expanded' => true,'choices'  => $array_acceso_servicio_basico), array());
    ...
    $this->widgetSchema['energia_electrica'] = new sfWidgetFormChoice(array('expanded' => true,'choices'  => $array_energia_electrica), array());
    ...
    $this->widgetSchema['bano'] = new sfWidgetFormChoice(array('expanded' => true,'choices'  => $array_bano), array());
    ...
    $this->widgetSchema['trabajo'] = new sfWidgetFormChoice(array('expanded' => true,'choices'  => $array_trabajo), array());
    ...
    $this->widgetSchema['recibio_pago'] = new sfWidgetFormChoice(array('expanded' => true,'choices'  => $array_recibio_pago), array());
    ...
    $this->widgetSchema['accede_internet'] = new sfWidgetFormChoice(array('expanded' => true, 'multiple' => true, 'choices'  => $array_accede_internet), array());
    ...
    $this->widgetSchema['frecuencia_internet'] = new sfWidgetFormChoice(array('expanded' => true,'choices' => $array_frecuencia_internet), array());
    ...
    $this->widgetSchema['transporte'] = new sfWidgetFormChoice(array('expanded' => true,'choices' => $array_transporte), array());
    ...
    $this->widgetSchema['tiempo_transporte'] = new sfWidgetFormChoice(array('expanded' => true,'choices' => $array_tiempo_transporte), array());
  ...
  public function updateDefaultsFromObject()
  {
    ...
    if (is_object($student))
    {
      ...
      // $contract = ContractPeer::getContract($student->getId(), $antepenultimo_periodo->getId());
      
      $contract = ContractPeer::getContract($student->getId(), sfContext::getInstance()->getUser()->getAttribute('period'));
      
      $contract_id['contract_id'] = $contract->getId();
      $values = array_merge($values, $contract_id);
      
      // Ponemos el nivel del estudiante
      $contract_grade = ContractGradePeer::getContractGrade($contract->getId(), null, 2);
      
      $grade = $contract_grade->getGrade();
      
      if($grade->getTimetableId() == 1)// Mañana
      {
	 $nivel_m['nivel_m'] = $grade->getId();
	 $values = array_merge($values, $nivel_m);
      } else if($grade->getTimetableId() == 2) // Tarde
      {
	 $nivel_t['nivel_t'] = $grade->getId();
	 $values = array_merge($values, $nivel_t);
      } else if($grade->getTimetableId() == 3)
      {
	 $nivel_n['nivel_n'] = $grade->getId();
	 $values = array_merge($values, $nivel_n);
      }
      
      // estudiante_direccion_provincia
      $attribute_contract_direccion_provincia = AttributeContractPeer::getAttributeByKeyAndContract('estudiante_direccion_provincia', $contract->getId());
      ...
      $attribute_contract_direccion_zona_villa = AttributeContractPeer::getAttributeByKeyAndContract('estudiante_direccion_zona_villa', $contract->getId());
      ...
      $attribute_contract_direccion_session_municipio = AttributeContractPeer::getAttributeByKeyAndContract('estudiante_direccion_session_municipio', $contract->getId());      
      ...
      $attribute_contract_direccion_avenida_calle = AttributeContractPeer::getAttributeByKeyAndContract('estudiante_direccion_avenida_calle', $contract->getId());
      ...
      $attribute_contract_direccion_localidad_comunidad = AttributeContractPeer::getAttributeByKeyAndContract('estudiante_direccion_localidad_comunidad', $contract->getId());
      ...
      $attribute_contract_direccion_celular = AttributeContractPeer::getAttributeByKeyAndContract('estudiante_direccion_celular', $contract->getId());
      ...
      $attribute_contract_direccion_numero_vivienda = AttributeContractPeer::getAttributeByKeyAndContract('estudiante_direccion_numero_vivienda', $contract->getId());
      ...
      // madre_apellido paterno
      $madre_apellidos['madre_apellido_paterno'] = is_object($tutor_madre) ? $tutor_madre->getFatherName() : null;
      $values = array_merge($values, $madre_apellidos);
     
      // madre_apellido materno
      $madre_apellidos['madre_apellido_materno'] = is_object($tutor_madre) ? $tutor_madre->getMotherName() : null;
      $values = array_merge($values, $madre_apellidos);
      ...
      // pertenece
      $question_pertenece = QuestionPeer::getAttributeByKeyAndStudent($contract->getId(), 'pertenece');
      ...
      // hospital_veces
      $question_hospital_veces = QuestionPeer::getAttributeByKeyAndStudent($contract->getId(), 'hospital_veces');
      ...
      $fecha_registro_dia['fecha_registro_dia'] = $contract->getRecordDate('d');
      $values = array_merge($values, $fecha_registro_dia);
      
      $fecha_registro_mes['fecha_registro_mes'] = $contract->getRecordDate('m');
      $values = array_merge($values, $fecha_registro_mes);
      
      $fecha_registro_anio['fecha_registro_anio'] = $contract->getRecordDate('Y');
      $values = array_merge($values, $fecha_registro_anio);
      
      $lugar_registro['lugar_registro'] = $contract->getCity();
      $values = array_merge($values, $lugar_registro);
