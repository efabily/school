 ...
 */
class RecordShortEditForm extends BaseStudentForm
{
  ...
  public function updateDefaultsFromObject()
  {
    ...
    if (is_object($student))
    {
	 ...
	 $values = array_merge($values, $nivel_n);
      ...
      //padre_tutor_apellido paterno
      $padre_tutor_apellidos['padre_tutor_apellido_paterno'] = is_object($tutor_padre) ? $tutor_padre->getFatherName() : null;
      $values = array_merge($values, $padre_tutor_apellidos);
     
      //padre_tutor_apellido materno
      $padre_tutor_apellidos['padre_tutor_apellido_materno'] = is_object($tutor_padre) ? $tutor_padre->getMotherName() : null;
      $values = array_merge($values, $padre_tutor_apellidos);
