...
<div class="sf_admin_filter">
  ...
  <form action="/Reports/FilterResumenMensualidad" method="post">
    <table cellspacing="0">      
      <tbody>
	 <tr>
             <td>
	 ...
	 <tr>
	    ...
	    <td>
	       <?php echo link_to('Limpiar', '/Reports/FilterResumenMensualidad', array('query_string' => '_reset', 'method' => 'post')) ?>
	    </td>
	 </tr>
      </tbody>
    </table>
