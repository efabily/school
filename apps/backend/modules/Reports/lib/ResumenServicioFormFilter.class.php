 ...
 */
class ResumenServicioFormFilter extends BaseStudentFormFilter
{
  ...
  {     
	...
	10 => 'OCTUBRE'
     ...
     $choices_item = ItemPeer::getArrayItemsServices();
     $this->setWidgets(array(
      ...
      'item_id' => new sfWidgetFormSelect(array('choices' => $choices_item, 'multiple' => true), array()),
    ...
    $this->setValidators(array(
      ...
      'item_id'    => new sfValidatorInteger(array('trim' => true, 'required' => false)),
      // 'item_id'    => new sfValidatorChoice(array('choices' => array($choices_item), 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('resumen_services_filters[%s]');
