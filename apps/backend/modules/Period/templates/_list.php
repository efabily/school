...
<!--	     <input id="sf_admin_list_batch_checkbox" type="checkbox" onclick="checkAll();" />-->
          ...
          <?php include_partial('Period/list_th_tabular', array('sort' => $sort)) ?>
        ...
        <tr>
          <th colspan="10">
            <?php if ($pager->haveToPaginate()): ?>
              <?php include_partial('Period/pagination', array('pager' => $pager)) ?>
            <?php endif; ?>
      ...
      <tbody>
        <?php foreach ($pager->getResults() as $i => $Period): $odd = fmod(++$i, 2) ? 'odd' : 'even' ?>
          <tr class="sf_admin_row <?php echo $odd ?>">
            ...
            <?php include_partial('Period/list_td_tabular', array('Period' => $Period)) ?>
