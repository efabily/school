...
require_once(dirname(__FILE__).'/../lib/BaseDiscountGeneratorConfiguration.class.php');
require_once(dirname(__FILE__).'/../lib/BaseDiscountGeneratorHelper.class.php');
 ...
 * @author     ##AUTHOR_NAME##
 */
abstract class autoDiscountActions extends sfActions
{
