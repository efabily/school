 ...
 */
abstract class BaseDiscountGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return '%%id%% - %%id_state%% - %%name%% - %%discount%% - %%description%% - %%created_at%% - %%updated_at%% - %%deleted_by%%';
  }
  ...
  {
    return array(  0 => 'id',  1 => 'id_state',  2 => 'name',  3 => 'discount',  4 => 'description',  5 => 'created_at',  6 => 'updated_at',  7 => 'deleted_by',);
  }
  ...
  public function getFieldsDefault()
  {
    return array(
      ...
      'discount' => array(  'is_link' => false,  'is_real' => true,  'is_partial' => false,  'is_component' => false,  'type' => 'Text',),
