...
require_once(dirname(__FILE__).'/../lib/BaseNightAuditGeneratorConfiguration.class.php');
require_once(dirname(__FILE__).'/../lib/BaseNightAuditGeneratorHelper.class.php');
 ...
 * @author     ##AUTHOR_NAME##
 */
abstract class autoNightAuditActions extends sfActions
{
