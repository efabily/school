...
require_once(dirname(__FILE__).'/../lib/BaseCashboxGeneratorConfiguration.class.php');
require_once(dirname(__FILE__).'/../lib/BaseCashboxGeneratorHelper.class.php');
 ...
 * @author     ##AUTHOR_NAME##
 */
abstract class autoCashboxActions extends sfActions
{
