...
abstract class BasePeriodGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return '%%id%% - %%id_state%% - %%name%% - %%from_date%% - %%to_date%% - %%deleted_by%% - %%created_at%% - %%updated_at%%';
  }
  ...
  {
    return array(  0 => 'id',  1 => 'id_state',  2 => 'name',  3 => 'from_date',  4 => 'to_date',  5 => 'deleted_by',  6 => 'created_at',  7 => 'updated_at',);
  }
