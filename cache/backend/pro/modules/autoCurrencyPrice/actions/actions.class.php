...
require_once(dirname(__FILE__).'/../lib/BaseCurrencyPriceGeneratorConfiguration.class.php');
require_once(dirname(__FILE__).'/../lib/BaseCurrencyPriceGeneratorHelper.class.php');
 ...
 * @author     ##AUTHOR_NAME##
 */
abstract class autoCurrencyPriceActions extends sfActions
{
