...
require_once(dirname(__FILE__).'/../lib/BaseTypeItemGeneratorConfiguration.class.php');
require_once(dirname(__FILE__).'/../lib/BaseTypeItemGeneratorHelper.class.php');
 ...
 * @author     ##AUTHOR_NAME##
 */
abstract class autoTypeItemActions extends sfActions
{
