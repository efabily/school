...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/var/www/log/backend_pro.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/www/cache/backend/pro/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/www/apps/backend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/cache/backend/pro/template',
  'lifetime' => 86400,
  'prefix' => '/var/www/apps/backend/template',
)));
